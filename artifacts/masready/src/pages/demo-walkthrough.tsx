...
const STEPS = [
  ...
  },
  {
    ...
    detail: "The top-level score (87/100) aggregates requirements coverage, patch risk, skill gaps, and licence headroom into one defensible number. Walk through each contributing factor.",
    proof: ["Intelligence Score: 87/100", "Score breakdown by dimension", "Trend sparkline"],
  },
  {
    title: "Trust Center",
    role: "Admin",
    ...
    detail: "The Trust Center shows every integration in READ-ONLY mode. No SQL exec, no Jira write, no Maximo write. The \"Zero Mutations\" counter proves no data was altered during the session.",
    proof: ["0 mutations badge", "Read-only integration list", "Trust boundary = REVIEW ONLY"],
  },
  {
    ...
    detail: "Open Integration Settings. Show that Jira, Azure DevOps, and Maximo connections are configured with read-only tokens. Write toggles are disabled at the platform level — not just via UI.",
    proof: ["Jira: READ scope only", "ADO: no write permission", "Maximo: fingerprint-read only"],
  },
  {
  ...
  },
  {
    ...
    detail: "The fingerprint scan identifies 46 customisations across MAS9 Manage — BOs, screen changes, scripts, workflow modifications. This snapshot is the baseline for all patch impact analysis.",
    proof: ["46 customisations detected", "Version: MAS 9.x Manage", "Scan is non-destructive"],
  },
  {
  ...
  },
  {
    ...
    summary: "Proves 82% coverage, gap identification",
    detail: "The skill matrix maps delivery team capabilities against the 46 customisations and patch requirements. 82% are covered — 8 gaps are flagged with suggested training or contractor profiles.",
    proof: ["82% skill coverage", "8 identified gaps", "Gap → recommended action"],
  },
  {
    ...
    summary: "Proves PFM disabled, feature flag respected",
    detail: "Toggle the \"Contract Mobilisation\" feature flag to OFF. Show that the Procurement + Finance Module (PFM) section disappears across all views — proving feature-flag driven control.",
    proof: ["PFM flag = OFF", "PFM menu hidden", "No data residue"],
  },
  {
    title: "Audit Log",
    role: "Auditor",
