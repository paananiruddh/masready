        ...
        <div className="container mx-auto px-6 lg:px-16 max-w-6xl">
          <div className="mb-12">
            ...
            <p className="text-sm text-muted-foreground mt-3 max-w-xl leading-relaxed">
              The live demo tenant lets you explore MASReady through seven distinct fictional personas — each with a different permission scope, module access, and view of the same environment.
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            ...
            >
              <ExternalLink className="w-4 h-4" />
              Enter the Demo Tenant — Select a Role
            </a>
