    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-28 pb-20 overflow-hidden border-b border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            Adaptive{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-violet-400 to-accent">
              ...
              >
                ...
                <div className="flex flex-col items-center shrink-0">
                  ...
                  {i < WORKFLOW_STEPS.length - 1 && (
                    <div className="w-px flex-1 bg-white/10 my-2 min-h-[20px]" />
                  )}
                </div>
                {/* Content */}
      ...
      {/* ── Feature Outputs ── */}
      <section className="py-24 bg-card/50 border-b border-white/5">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {OUTPUTS.map((o, i) => (
              <motion.div
                ...
                className="rounded-xl border border-white/10 bg-background/60 p-6 flex flex-col gap-4 hover:bg-white/5 hover:border-white/20 transition-all hover:-translate-y-1 cursor-default group"
              >
      ...
      <section className="py-24 border-b border-white/5">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto rounded-2xl border border-white/10 bg-card overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="rounded-2xl border border-accent/20 bg-gradient-to-br from-accent/5 to-primary/5 overflow-hidden">
              ...
              <div className="flex items-center gap-4 px-8 py-5 border-b border-accent/20 bg-accent/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold text-white">MAS9 Power — ARI Example</div>
                  </div>
                </div>
                <div className="ml-auto flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20">
                  ...
                  <span className="text-xs font-semibold text-amber-400">All data is fictional</span>
                </div>
              </div>
              ...
              <div className="px-8 py-7">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {MAS9_RECOMMENDATIONS.map((rec, i) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      transition={{ delay: i * 0.07 }}
                      className="flex items-start gap-4 rounded-xl border border-white/10 bg-background/40 p-4"
                    >
                ...
                <p className="mt-6 text-xs text-amber-400/80 flex items-start gap-2">
            ...
            <div className="space-y-4">
              {FAQ.map((item, i) => (
                <motion.div
                  ...
                  className="rounded-xl border border-white/10 bg-background/60 p-6"
                >
        ...
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/demo-walkthrough" className="inline-flex items-center gap-2 rounded-lg border border-white/15 bg-background px-8 py-3 text-sm font-semibold text-white hover:bg-white/5 transition-all hover:-translate-y-0.5">
