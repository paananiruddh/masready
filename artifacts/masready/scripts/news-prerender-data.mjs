/**
 * Article data for the prerender script.
 * Keep in sync with src/lib/newsArticles.ts.
 * Plain ESM — no TypeScript, no bundler needed.
 */
...
export const newsArticles = [
  {
    ...
    subtitle:
      "A read-only way to understand Maximo security groups, baseline roles, and MAS 9 access complexity before it becomes upgrade risk.",
    date: "2026-06-05",
    displayDate: "5 June 2026",
    category: "Product Update",
    readTime: "5 min read",
    summary:
      "MASReady is adding Security Profiles — a read-only governance module that turns raw Maximo security group data into role-based clarity before the complexity carries into MAS 9.",
    content: [
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "We built something about it" },
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "What you actually see" },
      { type: "heading", text: "Screen 1 — Security Overview" },
      {
        type: "image",
        ...
        caption:
          "The Security Overview dashboard — total groups, users, baseline roles detected, merge candidates, waste flags, and an AppPoint saving estimate.",
      },
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "Screen 2 — Baseline Roles" },
      {
        type: "image",
        ...
        caption:
          "Five baseline roles inferred from 66 groups — each with confidence score, user count, and source group mapping.",
      },
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "Screen 3 — Group Sprawl" },
      {
        type: "image",
        ...
        caption:
          "Groups clustered by similarity. Merge candidates and waste flags surfaced with full source evidence.",
      },
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "Screen 4 — Scenario Simulator" },
      {
        type: "image",
        ...
        caption:
          "What-if previews with before/after comparison — output is a review pack, not a change script.",
      },
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "Screen 5 — Evidence" },
      {
        type: "image",
        ...
        caption:
          "Every recommendation traces to specific rows in APPLICATIONAUTH, GROUPUSER, and MAXGROUP. Nothing is a black box.",
      },
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "Why read-only matters" },
      {
        type: "paragraph",
      ...
      { type: "hr" },
      { type: "heading", text: "Who this is built for" },
      {
        type: "paragraph",
